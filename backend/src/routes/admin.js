...
router.delete('/students/:studentId', async (req, res) => {
  ...
  try {
    ...
    await client.query('DELETE FROM student_requirements WHERE student_id = $1', [studentId]);
    await client.query('DELETE FROM messages WHERE audience_student_id = $1', [studentId]);

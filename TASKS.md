...
- [ ] **Task C: Mock School Data Seed** (SETUP:FILL)
...
- [ ] **Task D: Auth & User Login (Backend)**
...
- [ ] **Task E: Data Privacy Baseline**
  - Add `.env` template (SETUP:FILL: encryption keys, database URL, hosting region)

...
const STRINGS = {
  en: {
    ...
    user_management: 'User Management', requirements: 'Requirements', documents: 'Documents', messages: 'Messages',
    ...
    ui_theme: 'UI Theme', ui_theme_desc: 'Change how the whole portal looks',
    ui_theme_modern: 'Modern', ui_theme_win95: 'Windows Classic', ui_theme_win2000: 'Windows 2000',
  ...
  tl: {
    ...
    user_management: 'Pamamahala ng User', requirements: 'Mga Kinakailangan', documents: 'Mga Dokumento', messages: 'Mga Mensahe',
    ...
    ui_theme: 'Anyo ng UI', ui_theme_desc: 'Baguhin ang itsura ng buong portal',
    ui_theme_modern: 'Moderno', ui_theme_win95: 'Windows Classic', ui_theme_win2000: 'Windows 2000',
